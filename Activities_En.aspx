<%@ Page Title="" Language="C#" MasterPageFile="~/MainView_En.master" AutoEventWireup="true" CodeFile="Activities_En.aspx.cs" Inherits="Activities_En" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <div style="float:left;width:622px;min-height:1px;font-size:0px">
        <asp:Repeater ID="rptActivitiesList" runat="server">
            <ItemTemplate>
                ...
                <div style="float:left;width:490px;min-height:1px">
                    <div style="float:left;width:490px;min-height:1px">
                        <a href='English_ActivityDetail_<%# Eval("NEWS_ID") %>.html' class="listTitle"><%# Eval("TENSANPHAM")%></a>
                    </div>
                    ...
                    <div style="float:left;width:490px;min-height:1px;text-align:right">
                        <a href='English_ActivityDetail_<%# Eval("NEWS_ID") %>.html' class="listLink">Detail &raquo;</a>
                    </div>
                </div>
            </ItemTemplate>
            <SeparatorTemplate>
