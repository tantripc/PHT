<%@ Page Title="" Language="C#" MasterPageFile="~/MainView_En.master" AutoEventWireup="true" CodeFile="Contact_En.aspx.cs" Inherits="Contact_En" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <div style="float:left;width:572px;min-height:1px">
        <div style="float:left;width:332px;min-height:1px" class="contactTopLeftText">
            You can ask your questions on any other subjects here.
        </div>
        <div style="float:left;width:240px;min-height:1px;text-align:right" class="contactTopRightText">
            * compulsory fields
        </div>
            ...
            <asp:Panel ID="pnlContact" runat="server" DefaultButton="btnSend">
                ...
                <div style="float:left;width:320px;min-height:1px">
                    ...
                    <asp:RequiredFieldValidator ID="requireName" runat="server" CssClass="contactErrorMessage" ForeColor="Yellow"
                        ControlToValidate="txtName" Display="Dynamic" ErrorMessage="Name can not be blank!"></asp:RequiredFieldValidator>
                </div>
                ...
                <div style="float:left;width:320px;min-height:1px">
                    ...
                    <asp:RequiredFieldValidator ID="requireEmail" runat="server" CssClass="contactErrorMessage" ForeColor="Yellow"
                        ControlToValidate="txtEmail" Display="Dynamic" ErrorMessage="Email can not be blank!"></asp:RequiredFieldValidator>
                ...
                <div style="float:left;width:320px;min-height:1px">
                    ...
                    <asp:RequiredFieldValidator ID="requireSubject" runat="server" CssClass="contactErrorMessage" ForeColor="Yellow"
                        ControlToValidate="txtSubject" Display="Dynamic" ErrorMessage="Title can not be blank!"></asp:RequiredFieldValidator>
                </div>
                <div style="clear:both;height:10px;font-size:0px"></div>
                <div style="float:left;width:150px;min-height:1px;text-align:right" class="contactLabel">
                    Content:
                ...
                <div style="float:left;width:320px;min-height:1px">
                    ...
                    <asp:RequiredFieldValidator ID="requireMessage" runat="server" CssClass="contactErrorMessage" ForeColor="Yellow"
                        ControlToValidate="txtMessage" Display="Dynamic" ErrorMessage="Content can not be blank!"></asp:RequiredFieldValidator>
                </div>
                <div style="clear:both;height:15px;font-size:0px"></div>
                <div style="float:left;width:165px;min-height:1px"></div>
                <div style="float:left;width:320px;min-height:1px">
                    <asp:Button ID="btnSend" Width="80px" CssClass="midText" runat="server" Text="Send"
                        onclick="btnSend_Click" />
                    <input id="btnReset" type="reset" style="width:80px;margin-left:20px" class="midText" value="Reset" />
                </div>
            </asp:Panel>
