<%@ Page Title="" Language="C#" MasterPageFile="~/MainView.master" AutoEventWireup="true" CodeFile="Training.aspx.cs" Inherits="Training" %>
            ...
            <ItemTemplate>
                ...
                <div style="float:left;width:490px;min-height:1px">
                    ...
                    <div style="float:left;width:490px;min-height:1px;text-align:right">
                        <a href='TrainerDetail_<%# Eval("NEWS_ID") %>.html' class="listLink">Chi tiết &raquo;</a>
                    </div>
                </div>
            </ItemTemplate>
            <SeparatorTemplate>
