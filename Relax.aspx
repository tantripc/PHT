<%@ Page Title="" Language="C#" MasterPageFile="~/MainView.master" AutoEventWireup="true" CodeFile="Relax.aspx.cs" Inherits="Training" %>
        ...
        <asp:Repeater ID="rptTrainingList" runat="server">
            <ItemTemplate>
                ...
                <div style="float:left;width:490px;min-height:1px">
                    <div style="float:left;width:490px;min-height:1px">
                        <a href='RelaxDetail_<%# Eval("NEWS_ID") %>.html' class="listTitle"><%# Eval("TENSANPHAM")%></a>
                    </div>
                    ...
                    <div style="float:left;width:490px;min-height:1px;text-align:right">
                        <a href='RelaxDetail_<%# Eval("NEWS_ID") %>.html' class="listLink">Chi tiết &raquo;</a>
                    </div>
                </div>
            </ItemTemplate>
            <SeparatorTemplate>
