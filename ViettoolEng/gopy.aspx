<%@ Page Language="C#" MasterPageFile="~/ViettoolEng/MasterPage.master" AutoEventWireup="true" CodeFile="gopy.aspx.cs" Inherits="ViettoolEng_Default4" Title="Cap Nhat - Website" %>
                            ...
                            <asp:Panel ID="Panel1" runat="server">
                                ...
                                <asp:Label ID="MAILLabel" runat="server" CssClass="smallText" Text='<%# Eval("MAIL") %>'></asp:Label></td>
                                        ...
                                        <td colspan="2" style="width: 105153848px; height: 21px; background-color: #fff7fe">
                                            <asp:Image ID="Image3" runat="server" ImageUrl="~/ViettoolEng/images/hoi.gif" />
                                            &nbsp;
                                ...
                                <asp:Label ID="NOIDUNGLabel" runat="server" CssClass="smallText" Text='<%# Eval("NOIDUNG") %>' Height="80px" Width="469px"></asp:Label></td>
                                    ...
                                    <tr>
                                        <td colspan="2" style="width: 105153848px; height: 21px; background-color: #fff7fe">
                                            <asp:Image ID="Image4" runat="server" ImageUrl="~/ViettoolEng/images/dap.gif" />&nbsp;
