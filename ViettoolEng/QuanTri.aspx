<%@ Page Language="C#" MasterPageFile="~/ViettoolEng/MasterPage.master" AutoEventWireup="true" CodeFile="QuanTri.aspx.cs" Inherits="ViettoolEng_QuanTri" Title="Cap Nhat - Website" %>
...
<ItemStyle ForeColor="#2E62A9"></ItemStyle>
                ...
                <asp:TemplateField ItemStyle-HorizontalAlign="Center" HeaderText="Xoá" ShowHeader="False">
                    <ItemTemplate>
                        <asp:ImageButton ID="imgDelete" ImageUrl="~/ViettoolEng/images/icon_trashcan.gif" OnClientClick="return(confirm('Bạn có chắc xoá?'))" CommandName="Delete" runat="server" />
                    </ItemTemplate>
