...
public partial class ViettoolEng_MauHS : System.Web.UI.Page
{
    ...
    private void GetData()
    {
        try
        {
            ...
            string FolderPath = Server.MapPath("~/Apply_En");
    ...
    protected void btnUpload_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            for (int i = 0; i < hfc.Count; i++)
            {
                ...
                {
                    hpf.SaveAs(Server.MapPath("~/Apply_En") + "\\" +
