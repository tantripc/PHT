<%@ Page Language="C#" MasterPageFile="~/ViettoolEng/MasterPage.master" AutoEventWireup="true" CodeFile="Traloi.aspx.cs" Inherits="ViettoolEng_Default4" Title="Cap Nhat - Website" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <asp:Panel ID="Panel1" runat="server" GroupingText="Tóm tắt / Nội dung trả lời" 
        Width="823px">
        <fckeditorv2:fckeditor id="FCKeditor1" runat="server" EnableViewState="true" basepath="~/ViettoolEng/fckeditor/"
