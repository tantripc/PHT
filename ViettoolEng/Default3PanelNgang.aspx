<%@ Page Language="C#" MasterPageFile="~/ViettoolEng/MasterPage.master" AutoEventWireup="true" CodeFile="Default3PanelNgang.aspx.cs" Inherits="ViettoolEng_Default3" Title="Cap Nhat - Website" %>
    ...
    <table style="width: 815px">
        ...
        <tr>
            ...
            <td style="width: 722px">
                ...
                <asp:TextBox ID="TextBox10" runat="server" Width="55px" Visible="False"></asp:TextBox>
                <asp:TextBox ID="TextBox11" runat="server" Visible="False" Width="1px"></asp:TextBox></td>
        </tr>
    </table>
</asp:Content>
