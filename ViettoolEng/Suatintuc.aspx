<%@ Page Language="C#" MasterPageFile="~/ViettoolEng/MasterPage.master" AutoEventWireup="true" CodeFile="Suatintuc.aspx.cs" Inherits="ViettoolEng_Default4" Title="Cap Nhat - Website" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <table style="width: 814px; height: 686px">
                        ...
                        <tr>
                            <%--<td align="left" style="width: 352px" rowspan="2">
                                Hình ảnh Minh Hoạ<FCKeditorV2:FCKeditor ID="FCKeditor4" runat="server" 
                                    BasePath="~/ViettoolEng/fckeditor/">
        ...
        <tr>
            <td>
                &nbsp;Quảng cáo<FCKeditorV2:FCKeditor ID="FCKeditor4" runat="server" BasePath="~/ViettoolEng/fckeditor/" Height="310px">
                </FCKeditorV2:FCKeditor>
                &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
