<%@ Page Language="C#" MasterPageFile="~/ViettoolEng/MasterPage.master" AutoEventWireup="true" CodeFile="ChiTietSP.aspx.cs" Inherits="ViettoolEng_Default4" Title="Cap Nhat - Website" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    &nbsp;<br />
    &nbsp;
    <asp:ImageButton ID="ImageButton1" runat="server" AlternateText="Thêm Danh mục" ImageUrl="~/ViettoolEng/images/giohang.gif" Width="20px" />
