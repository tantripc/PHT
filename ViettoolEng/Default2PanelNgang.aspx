<%@ Page Language="C#" MasterPageFile="~/ViettoolEng/MasterPage.master" AutoEventWireup="true" CodeFile="Default2PanelNgang.aspx.cs" Inherits="ViettoolEng_Default2" Title="Cap Nhat - Website" ValidateRequest="false" Trace="false" MaintainScrollPositionOnPostback="true" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <FCKeditorV2:FCKeditor ID="FCKeditor1" runat="server" BasePath="~/ViettoolEng/fckeditor/" Height="350px" Width="100%">
