<%@ Page Title="" Language="C#" MasterPageFile="~/ViettoolEng/MasterPage.master" AutoEventWireup="true"
    CodeFile="ThemPanelPhai.aspx.cs" Inherits="ViettoolEng_ThemPanelPhai" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <table style="width: 814px; height: 686px">
            ...
            <td align="center">
                &nbsp;<table border="0" style="width: 595px">
                    <tr>
                        ...
                        <td align="left">
                            <asp:TextBox ID="txtSTT" runat="server" Width="60px"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                        <td align="left" style="width: 109px">
        ...
        <tr>
            <td>
                &nbsp;Nội dung chi tiết<FCKeditorV2:FCKeditor ID="FCKeditor3" runat="server" BasePath="~/ViettoolEng/fckeditor/"
                    Height="310px">
                </FCKeditorV2:FCKeditor>
                &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
