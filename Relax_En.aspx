<%@ Page Title="" Language="C#" MasterPageFile="~/MainView_En.master" AutoEventWireup="true" CodeFile="Relax_En.aspx.cs" Inherits="Training" %>
        ...
        <asp:Repeater ID="rptTrainingList" runat="server">
            <ItemTemplate>
                ...
                <div style="float:left;width:490px;min-height:1px">
                    <div style="float:left;width:490px;min-height:1px">
                        <a href='TrainerDetail_<%# Eval("NEWS_ID") %>.html' class="listTitle"><%# Eval("TENSANPHAM")%></a>
                    </div>
                    ...
                    <div style="float:left;width:490px;min-height:1px;text-align:right">
                        <a href='TrainerDetail_<%# Eval("NEWS_ID") %>.html' class="listLink">Detail &raquo;</a>
                    </div>
                </div>
            </ItemTemplate>
            <SeparatorTemplate>
