<%@ Page Language="C#" MasterPageFile="~/Viettool/MasterPage.master" AutoEventWireup="true" CodeFile="PanelNgang.aspx.cs" Inherits="Viettool_Default" Title="Cap Nhat - Website" %>
...
<center>
    ...
    <asp:GridView ID="gvMainMenu" runat="server" GridLines="Horizontal"
        ...
        Width="720px" BackColor="#F9F8E3" TabIndex="1" 
            ...
            <asp:TemplateField ShowHeader="False">
                <ItemTemplate>
                    <asp:ImageButton  ID="LinkButton2" runat="server" CausesValidation="true" CommandName="AddMenu"
                       AlternateText="Thêm Menu" ImageUrl="~/Viettool/imgtoolbar/NEW.GIF" ></asp:ImageButton>
                </ItemTemplate>
            </asp:TemplateField>
    ...
    <div style="width:97%;text-align:right">
        ...
        Height="13px" ImageUrl="~/Viettool/images/icon1.gif" OnClientClick="return false;"
        Width="14px" />
        &nbsp;
        <asp:HyperLink ID="HyperLink1" runat="server" 
            NavigateUrl="~/Viettool/AddPanelNgang.aspx?CHANNEL_ID=41" 
            ...
            <asp:Panel ID="pnlChildOfList" runat="server">
                <div style="text-align: center">
                    ...
                    <asp:GridView ID="GridView7" runat="server" AutoGenerateColumns="False"
                        ...
                        Width="720px" OnSelectedIndexChanged="GridView7_SelectedIndexChanged"
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField ShowHeader="true">
                                <HeaderTemplate>
                                    <asp:Image ID="imgNew" ImageUrl="~/Viettool/images/imgNew.gif" runat="server" />
                                </HeaderTemplate>
                                <ItemTemplate>
                                    <asp:ImageButton ID="lbtnAdd" runat="server" CausesValidation="true" CommandName="Add"
                                        AlternateText="Thêm" ImageUrl="~/Viettool/images/icon1.gif" >
                                    </asp:ImageButton>
                                </ItemTemplate>
                            </asp:TemplateField>
                            <asp:TemplateField ShowHeader="false">
                                <ItemTemplate>
                                    <asp:ImageButton ID="lbtnShowSP" runat="server" CausesValidation="true" CommandName="ShowSP"
                                        AlternateText="ShowSP" ImageUrl="~/Viettool/images/giohang.gif" >
                                    </asp:ImageButton>
                                </ItemTemplate>
                            </asp:TemplateField>
                            <asp:TemplateField>
                                        ...
                                        <td colspan="100%">
                                            <div id="div<%# Eval("STT") %>" 
                                                ...
                                                <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False"
                                                    ...
                                                    Width="680px" ShowHeader="false" OnRowDeleting="GridView1_RowDeleting"
