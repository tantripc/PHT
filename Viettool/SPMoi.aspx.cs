...
public partial class Viettool_SPMoi : System.Web.UI.Page
{
    ...
    {
        SqlDataAdapter da = new SqlDataAdapter("select NEWS_ID, STT, NOIDUNG, TOMTAT, NGAY, USERID from SANPHAM where CHANNEL_ID = 44 order by STT", con);
    ...
    protected void GridView1_SelectedIndexChanged(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            Response.Redirect("~/Viettool/SuaSPMoi.aspx?nid=" + nid);
