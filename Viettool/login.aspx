<%@ Page Language="C#" AutoEventWireup="true" CodeFile="login.aspx.cs" Inherits="Viettool_login" %>
            ...
            <table style="width: 849px; height: 131px; background-color: #c2cee2; " border="0" align="center">
                <tr>
                    <td style="width: 9px; height: 5px;">
                        <asp:Image ID="Image3" runat="server" Height="12px" ImageUrl="~/Viettool/images/login_r1_c1.gif"
                            Width="17px" /></td>
                    <td colspan="2" style="height: 5px">
                        </td>
                    <td style="width: 21px; height: 5px">
                        <asp:Image ID="Image1" runat="server" ImageUrl="~/Viettool/images/login_r1_c7.gif" /></td>
                </tr>
                <tr>
                    ...
                    <td rowspan="5" style="width: 1038px">
                        <table style="width: 223px; background-color: #005aaa; height: 347px;">
                            <tr>
                                <td style="width: 12px">
                                    <asp:Image ID="Image5" runat="server" ImageUrl="~/Viettool/images/login_r2_c4.gif" /></td>
                            ...
                            <tr>
                                ...
                                <td style="">
                                    <asp:Image ID="Image6" runat="server" Height="10px" ImageUrl="~/Viettool/images/login_r8_c6.gif"
                                        Width="4px" /></td>
                            </tr>
                        </table>
                    </td>
                ...
                <tr>
                    <td style="">
                        <asp:Image ID="Image4" runat="server" ImageUrl="~/Viettool/images/login_r9_c1.gif" /></td>
                    <td colspan="2" style="height: 21px">
                    </td>
                    <td style="">
                        <asp:Image ID="Image2" runat="server" ImageUrl="~/Viettool/images/login_r9_c7.gif" /></td>
                </tr>
            </table>
