<%@ Page Language="C#" MasterPageFile="~/Viettool/MasterPage.master" AutoEventWireup="true" CodeFile="Suasanpham.aspx.cs" Inherits="Viettool_Default4" Title="Cap Nhat - Website" %>
    ...
    <table style="width: 814px; height: 686px">
        <tr>
            <td style="width: 124px">
                &nbsp;Hình ảnh / Tóm tắt<FCKeditorV2:FCKeditor ID="FCKeditor1" runat="server" BasePath="~/Viettool/fckeditor/"
        ...
        <tr>
            <td colspan="3" style="height: 21px">
                &nbsp;Mô tả Sản phẩm<%--<FCKeditorV2:FCKeditor ID="FCKeditor2" runat="server" BasePath="~/Viettool/fckeditor/"
